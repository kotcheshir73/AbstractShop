...
namespace AbstractShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IClientService, ClientServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IComponentService, ComponentServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IImplementerService, ImplementerServiceBD>(new HierarchicalLifetimeManager());
